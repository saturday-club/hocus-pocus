...
/// Shows tint + grain in the notch ear areas (beside the camera housing).
@MainActor
final class NotchEarOverlay {
    ...
    func show(on screen: NSScreen, state: AppState) {
    ...
    private func showEar(_ ear: inout Ear?, rect: CGRect, screen: NSScreen, state: AppState) {
    ...
    private func makeEar(frame: CGRect, screen: NSScreen) -> Ear {
        ...
        // Grain (Metal compute shader, overlay blend mode)
    ...
    private func applyEffects(_ ear: Ear?, state: AppState) {
